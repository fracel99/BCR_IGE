...
# USAGE:
# ./universal_prep_IGE_V3.sh GEO_ID mouseX DOWNLOAD_LINK
...
wget "$DOWNLOAD_LINK" -O "${WORKDIR}_raw.gz"
gunzip "${WORKDIR}_raw.gz"
CSV="${WORKDIR}_raw"
...
# If file is TSV (tab-separated), convert to comma-separated
