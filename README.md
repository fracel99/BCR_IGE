This project aims to find conserved and variable regions in the VDJ genes of mouse and human by analizing available data on BCRs, more specifically IgEs.
